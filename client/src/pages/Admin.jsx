    ...
    <div className={styles.wrap}>
      ...
      <div className={styles.cards}>
        <div className={styles.card}>
          ...
          <Link to="/dashboard/staff">View staff →</Link>
        </div>
        <div className={styles.card}>
          <h3>Patients</h3>
        ...
        <div className={styles.card}>
          ...
          <Link to="/dashboard/doctors">View doctors →</Link>
        </div>
        <div className={styles.card}>
          <h3>Appointments</h3>
      ...
      <section className={styles.section}>
        <h2>Admin actions</h2>
        <ul>
          <li><Link to="/dashboard/staff">Manage staff & doctor accounts</Link></li>
          <li><Link to="/dashboard/patients">View all patient records</Link></li>
          <li><Link to="/dashboard/appointments">View all appointments</Link></li>
        </ul>
      </section>
    </div>
  );
